	...
	<view class="newnav">
		<view class="nav">
			...
			<view class="newcenter">
				<text class="newtext" @click="toUrl('earn')">HOW TO USE</text>
				<text class="newtext" @click="toUrl('create')">CREATE</text>
				<text class="newtext _marleft" @click="toUrl('market')">MARKETPLACE</text>
				<text class="newtext _last" @click="toUrl('gants')">GRANTS</text>
