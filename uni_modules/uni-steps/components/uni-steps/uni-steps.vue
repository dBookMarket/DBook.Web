			...
			<view :class="[direction==='column'?'uni-steps__column-container':'uni-steps__row-container']">
				<view :class="[direction==='column'?'uni-steps__column-line-item':'uni-steps__row-line-item']"
					...
					<view :class="[direction==='column'?'uni-steps__column-check':'uni-steps__row-check']"
						v-if="index<=active">
						<uni-icons :color="activeColor" :type="activeIcon" size="24"></uni-icons>
					</view>
					<view v-else :class="[direction==='column'?'uni-steps__column-check':'uni-steps__row-check']">
						<uni-icons :color="deactiveColor" :type="deactiveIcon" size="24"></uni-icons>
					</view>
					<view
